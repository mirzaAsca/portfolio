...
const Tech = () => {
  ...
  const imageUrls = [
    ...
    "https://blog.logrocket.com/wp-content/uploads/2021/11/python-rest-api-flask-connexion.png",
    "https://www.kindpng.com/picc/m/744-7444441_selenium-hd-png-download.png",
  ];

  const imageUrls2 = [
    "https://i.gadgets360cdn.com/large/microsoft_office_logo_website_1615273946358.jpg?downsize=950:*",
    ...
    "https://downloadr2.apkmirror.com/wp-content/uploads/2020/12/53/5fd5c4691f439.png",
            ...
            <div className="scrolling">
              {doubleImageUrls.map((url, index) => (
                <figure key={index} className="card tech-card">
                  {" "}
                  <img key={index} src={url} alt={`Coding Tech ${index + 1}`} />
                </figure>
              ))}
            </div>
          </div>
